...
class RecommendTests(unittest.TestCase):
    def test_plateau_rule_selects_expected_k(self) -> None:
        ...
        self.assertEqual(result.chosen_rule, "plateau_with_tier2_guardrail")

    def test_tier2_guardrail_blocks_candidate(self) -> None:
        metrics = pd.DataFrame(
            [
                {"k": 3, "solver_status": "OPTIMAL", "objective": 100, "objective_improvement_pct_from_prev_k": None, "tier1_avg_drive": 50, "tier1_improvement_pct_from_prev_k": None, "tier2_avg_drive": 45},
                {"k": 4, "solver_status": "OPTIMAL", "objective": 80, "objective_improvement_pct_from_prev_k": 20.0, "tier1_avg_drive": 40, "tier1_improvement_pct_from_prev_k": 20.0, "tier2_avg_drive": 40},
                {"k": 5, "solver_status": "OPTIMAL", "objective": 77, "objective_improvement_pct_from_prev_k": 3.75, "tier1_avg_drive": 38.5, "tier1_improvement_pct_from_prev_k": 3.75, "tier2_avg_drive": 35.0},
                {"k": 6, "solver_status": "OPTIMAL", "objective": 75, "objective_improvement_pct_from_prev_k": 2.60, "tier1_avg_drive": 37.8, "tier1_improvement_pct_from_prev_k": 1.82, "tier2_avg_drive": 34.5},
            ]
        )
        result = recommend_k(metrics, RecommendationConfig())
